...
import {
  RoundData,
  RoundsContainer,
} from "../components/ScheduledMatchBlob/ScheduledMatchBlob.styled";
...
const HistoryMatchBlob: React.FC<Props> = ({
  event: { title, date, matchDetailsLink, goals, goalsAtRoundsEnd },
}) => {
  ...
  return (
    <article className="pt-4">
      ...
      <Text align="center">{`${sumGoalsForEachHalf(goals).firstHalf} - ${
        sumGoalsForEachHalf(goals).secondHalf
      }`}</Text>
      ...
      <RoundsContainer>
        <RoundData>
          <Text>
            <b className="mr-2 text-blue-800">
              {sumGoalsForEachHalf(goalsAtRoundsEnd).firstHalf}
            </b>
          </Text>
        </RoundData>
        <RoundData last noIndicator>
          <Text>
            <b className="-ml-2 text-blue-800">
              {sumGoalsForEachHalf(goalsAtRoundsEnd).secondHalf}
            </b>
          </Text>
        </RoundData>
      </RoundsContainer>
